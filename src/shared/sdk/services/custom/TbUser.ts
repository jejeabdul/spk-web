...
/**
 * Api services for the `TbUser` model.
 */
@Injectable()
export class TbUserApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `TbUser` object.)
   * </em>
   */
  public findByIdAccessTokens(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/TbUsers/:id/accessTokens/:fk";
  ...
  /**
   * Queries accessTokens of TbUser.
   *
   * @param {any} id TbUser id
   *
   * @param {object} filter 
  ...
  public getCurrent(): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/TbUsers" + "/:id";
   ...
   * call to {@link sdk.TbUser#login} or
   * {@link sdk.TbUser#getCurrent}. Return null when there
  ...
  /**
   * @name sdk.TbUser#isAuthenticated
   *
